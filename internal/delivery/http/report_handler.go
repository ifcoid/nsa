...
func (h *SessionHandler) HandoffGuide(w http.ResponseWriter, req *http.Request) {
	...
	w2("2. Unggah SATU paket: Protokol, Paket Reproducibility, Laporan, manuskrip `.tex`/`.bib`, dan Handoff ini. (Opsional: ekspor read-only data ekstraksi/screening dari Mongo sebagai `.json`/`.csv` — HAPUS kredensial.)")
